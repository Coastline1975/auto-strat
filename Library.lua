...
local function StartEasyMode()
    ...
    task.spawn(function()
        ...
        while Globals.Easy and content == nil do
            local success, res = pcall(function() 
                return game:HttpGet("https://raw.githubusercontent.com/Coastline1975/auto-strat/refs/heads/Coastline1975-patch-1/Strategies/Easy.lua") 
            end)
...
-- // ui
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/Coastline1975/auto-strat/refs/heads/Coastline1975-patch-1/Sources/UI.lua"))()
        ...
        Callback = function(v)
            ...
            if v and GameState == "GAME" then
                if #executed_actions > 0 then
                    local content = "local TDS = shared.TDSTable or loadstring(game:HttpGet(\"https://raw.githubusercontent.com/Coastline1975/auto-strat/refs/heads/Coastline1975-patch-1/Library.lua\"))()\n\n"
...
local RecorderInit = loadstring(game:HttpGet("https://raw.githubusercontent.com/Coastline1975/auto-strat/refs/heads/Coastline1975-patch-1/Sources/Recorder.lua"))()
RecorderInit({
    Window = Window,
        ...
        TDS[methodName] = function(self, ...)
            if not Globals.tdsReplaying and GameState == "GAME" then
                ...
                if methodName == "Mode" then
                    ...
                    local strategyFileContent = "local TDS = shared.TDSTable or loadstring(game:HttpGet(\"https://raw.githubusercontent.com/Coastline1975/auto-strat/refs/heads/Coastline1975-patch-1/Library.lua\"))()\n\n"
